...
class BertBLSTMPunc(nn.Layer):
    def __init__(self, pretrained_token="bert-large-uncased", output_size=4, dropout=0.0, bert_size=768, 
                    blstm_size=128, num_blstm_layers=2, init_scale=0.1):
        ...
        self.lstm = nn.LSTM(input_size=bert_size, hidden_size=blstm_size,
                             num_layers=num_blstm_layers, direction="bidirect",
